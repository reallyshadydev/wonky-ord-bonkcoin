  ...
  pub(crate) fn run(self, options: Options, index: Arc<Index>, handle: Handle) -> SubcommandResult {
    Runtime::new()?.block_on(async {
      ...
      let router = Router::new()
        ...
        .route("/bnk20/tick/:tick", get(Self::drc20_tick_info))
        .route("/bnk20/tick", get(Self::drc20_all_tick_info))
        .route(
          "/bnk20/tick/:tick/address/:address/balance",
          get(Self::drc20_balance),
        )
        .route(
          "/bnk20/address/:address/balance",
